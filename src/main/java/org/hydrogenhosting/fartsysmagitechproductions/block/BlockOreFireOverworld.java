...
public class BlockOreFireOverworld extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_fire_overworld")
	public static final Block block = null;
	public BlockOreFireOverworld(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 3);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_fire_overworld", "inventory"));
	}
