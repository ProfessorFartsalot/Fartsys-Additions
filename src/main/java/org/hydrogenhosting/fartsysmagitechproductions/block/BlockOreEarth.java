...
import org.hydrogenhosting.fartsysmagitechproductions.item.ItemCrystalEarth;
...
public class BlockOreEarth extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_earth")
	public static final Block block = null;
	public BlockOreEarth(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_earth", "inventory"));
	}
