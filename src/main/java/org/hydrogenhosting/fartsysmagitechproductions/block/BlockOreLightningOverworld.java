...
public class BlockOreLightningOverworld extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_lightning_overworld")
	public static final Block block = null;
	public BlockOreLightningOverworld(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 6);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_lightning_overworld", "inventory"));
	}
