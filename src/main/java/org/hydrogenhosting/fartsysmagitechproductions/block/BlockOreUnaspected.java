...
import org.hydrogenhosting.fartsysmagitechproductions.item.ItemCrystalUnaspected;
...
public class BlockOreUnaspected extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_unaspected")
	public static final Block block = null;
	public BlockOreUnaspected(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 7);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_unaspected", "inventory"));
	}
