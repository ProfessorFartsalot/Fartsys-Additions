...
import org.hydrogenhosting.fartsysmagitechproductions.item.CrystalIceItem;
...
public class OreIceBlock extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:ore_ice")
	public static final Block block = null;

	public OreIceBlock(FartsysmagitechproductionsModElements instance) {
		super(instance, 4);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalIceItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fartsysmagitechproductions:ore_ice_match"),
			...
			event.getRegistry().register(feature.setRegistryName("ore_ice"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fartsysmagitechproductions:ore_ice"), configuredFeature);
		}
	}
