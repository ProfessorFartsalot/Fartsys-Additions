...
import org.hydrogenhosting.fartsysmagitechproductions.item.CrystalWindItem;
...
public class OreWindBlock extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:ore_wind")
	public static final Block block = null;

	public OreWindBlock(FartsysmagitechproductionsModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalWindItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fartsysmagitechproductions:ore_wind_match"),
			...
			event.getRegistry().register(feature.setRegistryName("ore_wind"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fartsysmagitechproductions:ore_wind"), configuredFeature);
		}
	}
