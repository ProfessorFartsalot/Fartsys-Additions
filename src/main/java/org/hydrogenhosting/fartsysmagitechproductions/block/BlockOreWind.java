...
import org.hydrogenhosting.fartsysmagitechproductions.item.ItemCrystalWind;
...
public class BlockOreWind extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_wind")
	public static final Block block = null;
	public BlockOreWind(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 9);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_wind", "inventory"));
	}
