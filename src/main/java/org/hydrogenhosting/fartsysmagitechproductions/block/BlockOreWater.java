...
import org.hydrogenhosting.fartsysmagitechproductions.item.ItemCrystalWater;
...
public class BlockOreWater extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:ore_water")
	public static final Block block = null;
	public BlockOreWater(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 8);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechproductions:ore_water", "inventory"));
	}
