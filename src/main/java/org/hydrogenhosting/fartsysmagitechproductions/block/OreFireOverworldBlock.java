...
import org.hydrogenhosting.fartsysmagitechproductions.item.CrystalFireItem;
...
public class OreFireOverworldBlock extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:ore_fire_overworld")
	public static final Block block = null;

	public OreFireOverworldBlock(FartsysmagitechproductionsModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ore_fire_overworld");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalFireItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fartsysmagitechproductions:ore_fire_overworld_match"),
			...
			event.getRegistry().register(feature.setRegistryName("ore_fire_overworld"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fartsysmagitechproductions:ore_fire_overworld"),
					configuredFeature);
		}
	}
