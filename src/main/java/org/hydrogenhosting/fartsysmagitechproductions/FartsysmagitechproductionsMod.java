 ...
 *
 *    Keep the ElementsFartsysmagitechproductionsMod object in this class and all calls to this object
...
public class FartsysmagitechproductionsMod {
	...
	@Mod.Instance(MODID)
	public static FartsysmagitechproductionsMod instance;
	public ElementsFartsysmagitechproductionsMod elements = new ElementsFartsysmagitechproductionsMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsFartsysmagitechproductionsMod.GuiHandler());
