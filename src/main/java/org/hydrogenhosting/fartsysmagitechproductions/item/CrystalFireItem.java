...
public class CrystalFireItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:crystal_fire")
	public static final Item block = null;

	public CrystalFireItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 14);
	}
