...
public class EnchantedEnderPearlInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_ender_pearl_ink")
	public static final Item block = null;

	public EnchantedEnderPearlInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 43);
	}
