...
public class ShardEarthItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_earth")
	public static final Item block = null;

	public ShardEarthItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 10);
	}
