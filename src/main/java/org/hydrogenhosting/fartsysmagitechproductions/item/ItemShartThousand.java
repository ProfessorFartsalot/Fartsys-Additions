...
public class ItemShartThousand extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:shart_thousand")
	public static final Item block = null;
	public ItemShartThousand(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 55);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:shart_thousand", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("shart_thousand");
			setRegistryName("shart_thousand");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Finally");
			list.add("one kilo shart per second!");
		}
	}
}
