...
public class EnchantedDiamondInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_diamond_ink")
	public static final Item block = null;

	public EnchantedDiamondInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 36);
	}
