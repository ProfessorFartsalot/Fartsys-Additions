...
import org.hydrogenhosting.fartsysmagitechproductions.procedure.ProcedureJRLandslideRightClickedInAir;
...
public class ItemJRLandslide extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:jr_landslide")
	public static final Item block = null;
	public ItemJRLandslide(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 123);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:jr_landslide", "inventory"));
	}
