...
public class ShartOneItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_one")
	public static final Item block = null;

	public ShartOneItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 49);
	}
