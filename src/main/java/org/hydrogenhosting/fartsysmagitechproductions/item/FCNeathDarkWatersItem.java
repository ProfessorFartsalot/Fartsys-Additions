...
public class FCNeathDarkWatersItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_neath_dark_waters")
	public static final Item block = null;

	public FCNeathDarkWatersItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 150);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fc_neath_dark_waters");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for Neath Dark Waters."));
		}
	}
}
