...
public class FCLandslideItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_landslide")
	public static final Item block = null;

	public FCLandslideItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 145);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for Landslide."));
		}
	}
}
