...
public class ShartTwoHundredThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_two_hundred_thousand")
	public static final Item block = null;

	public ShartTwoHundredThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 60);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Two hundred thousand sharts."));
		}
	}
}
