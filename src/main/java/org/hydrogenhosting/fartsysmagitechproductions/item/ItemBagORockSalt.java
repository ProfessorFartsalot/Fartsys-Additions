...
import org.hydrogenhosting.fartsysmagitechproductions.procedure.ProcedureBagORockSaltSpawnRockSalt;
...
public class ItemBagORockSalt extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:bag_o_rock_salt")
	public static final Item block = null;
	public ItemBagORockSalt(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 47);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:bag_o_rock_salt", "inventory"));
	}
