...
public class AMDInterphosP1Item extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_interphos_p_1")
	public static final Item block = null;

	public AMDInterphosP1Item(FartsysmagitechproductionsModElements instance) {
		super(instance, 89);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.interphosp1")),
