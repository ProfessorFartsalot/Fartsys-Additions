...
public class ClusterIceItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_ice")
	public static final Item block = null;

	public ClusterIceItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 18);
	}
