...
public class AMDLocusItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_locus")
	public static final Item block = null;

	public AMDLocusItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 91);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.locus")),
