...
public class ItemFCExponentialEntropyPrimals extends ElementsFartsysmagitechproductionsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:fc_exponential_entropy_primals", "inventory"));
	}
