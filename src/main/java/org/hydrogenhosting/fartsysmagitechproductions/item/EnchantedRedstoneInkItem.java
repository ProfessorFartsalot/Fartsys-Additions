...
public class EnchantedRedstoneInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_redstone_ink")
	public static final Item block = null;

	public EnchantedRedstoneInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 38);
	}
