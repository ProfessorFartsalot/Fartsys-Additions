...
public class AMDALongFallItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amda_long_fall")
	public static final Item block = null;

	public AMDALongFallItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 69);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.alongfall")),
