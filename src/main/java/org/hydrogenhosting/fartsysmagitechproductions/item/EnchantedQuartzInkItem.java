...
public class EnchantedQuartzInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_quartz_ink")
	public static final Item block = null;

	public EnchantedQuartzInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 41);
	}
