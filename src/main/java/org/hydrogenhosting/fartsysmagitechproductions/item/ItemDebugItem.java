...
import org.hydrogenhosting.fartsysmagitechproductions.procedure.ProcedureDebugItemRightClickedOnBlock;
...
public class ItemDebugItem extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:debug_item")
	public static final Item block = null;
	public ItemDebugItem(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 67);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:debug_item", "inventory"));
	}
