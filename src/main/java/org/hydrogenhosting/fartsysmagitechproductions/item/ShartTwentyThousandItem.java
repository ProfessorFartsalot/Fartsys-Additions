...
public class ShartTwentyThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_twenty_thousand")
	public static final Item block = null;

	public ShartTwentyThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 58);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Twenty thousand sharts."));
		}
	}
}
