...
public class ClusterWaterItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_water")
	public static final Item block = null;

	public ClusterWaterItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 27);
	}
