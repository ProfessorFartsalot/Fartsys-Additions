...
public class ShartTwoThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_two_thousand")
	public static final Item block = null;

	public ShartTwoThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 56);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("TWO kilo sharts per second!"));
		}
	}
}
