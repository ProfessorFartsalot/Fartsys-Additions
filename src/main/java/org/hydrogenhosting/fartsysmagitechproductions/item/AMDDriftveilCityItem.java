...
public class AMDDriftveilCityItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_driftveil_city")
	public static final Item block = null;

	public AMDDriftveilCityItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 82);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.driftveilchiptune")),
