...
public class ItemShartHundredThousand extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:shart_hundred_thousand")
	public static final Item block = null;
	public ItemShartHundredThousand(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 59);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:shart_hundred_thousand", "inventory"));
	}
