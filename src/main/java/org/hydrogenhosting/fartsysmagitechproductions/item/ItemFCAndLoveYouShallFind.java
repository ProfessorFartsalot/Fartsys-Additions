...
public class ItemFCAndLoveYouShallFind extends ElementsFartsysmagitechproductionsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:fc_and_love_you_shall_find", "inventory"));
	}
