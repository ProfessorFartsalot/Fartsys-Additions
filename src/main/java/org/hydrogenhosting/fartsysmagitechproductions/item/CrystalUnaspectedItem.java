...
public class CrystalUnaspectedItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:crystal_unaspected")
	public static final Item block = null;

	public CrystalUnaspectedItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 23);
	}
