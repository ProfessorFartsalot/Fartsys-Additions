...
public class AMDAthenaTheTirelessOneItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_athena_the_tireless_one")
	public static final Item block = null;

	public AMDAthenaTheTirelessOneItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 72);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.athenathetirelessone")),
