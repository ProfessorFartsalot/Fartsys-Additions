...
public class ShartThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_thousand")
	public static final Item block = null;

	public ShartThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 55);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Finally"));
			list.add(new StringTextComponent("one kilo shart per second!"));
		}
	}
}
