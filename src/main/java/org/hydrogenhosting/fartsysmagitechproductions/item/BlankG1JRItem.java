...
public class BlankG1JRItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:blank_g_1_jr")
	public static final Item block = null;

	public BlankG1JRItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 31);
	}
