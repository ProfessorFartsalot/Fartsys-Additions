...
public class ItemAMDAthenaTheTirelessOne extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_athena_the_tireless_one")
	public static final Item block = null;
	public ItemAMDAthenaTheTirelessOne(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 72);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_athena_the_tireless_one", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_athena_the_tireless_one",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.athenathetirelessone")));
