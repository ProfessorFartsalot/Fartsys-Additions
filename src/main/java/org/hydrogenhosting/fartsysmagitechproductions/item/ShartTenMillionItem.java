...
public class ShartTenMillionItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_ten_million")
	public static final Item block = null;

	public ShartTenMillionItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 63);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(FartsysAdditionsItemGroup.tab).maxStackSize(64).isImmuneToFire().rarity(Rarity.EPIC));
			setRegistryName("shart_ten_million");
		}
