...
public class AMDBruteChiptuneItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_brute_chiptune")
	public static final Item block = null;

	public AMDBruteChiptuneItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 77);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.brutechiptune")),
