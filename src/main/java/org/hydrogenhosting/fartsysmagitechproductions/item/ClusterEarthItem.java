...
public class ClusterEarthItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_earth")
	public static final Item block = null;

	public ClusterEarthItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 12);
	}
