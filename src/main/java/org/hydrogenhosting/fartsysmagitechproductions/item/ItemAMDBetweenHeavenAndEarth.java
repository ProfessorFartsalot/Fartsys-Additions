...
public class ItemAMDBetweenHeavenAndEarth extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_between_heaven_and_earth")
	public static final Item block = null;
	public ItemAMDBetweenHeavenAndEarth(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 75);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_between_heaven_and_earth", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_between_heaven_and_earth",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.betweenchipsandtunes")));
