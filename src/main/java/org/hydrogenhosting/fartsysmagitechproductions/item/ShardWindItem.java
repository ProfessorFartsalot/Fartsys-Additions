...
public class ShardWindItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_wind")
	public static final Item block = null;

	public ShardWindItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 28);
	}
