...
public class ItemEnchantedGlowstoneInk extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:enchanted_glowstone_ink")
	public static final Item block = null;
	public ItemEnchantedGlowstoneInk(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 39);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:enchanted_glowstone_ink", "inventory"));
	}
