...
public class FCALongFallItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fca_long_fall")
	public static final Item block = null;

	public FCALongFallItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 142);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for A Long Fall."));
		}
	}
}
