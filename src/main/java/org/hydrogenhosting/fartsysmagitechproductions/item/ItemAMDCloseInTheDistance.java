...
public class ItemAMDCloseInTheDistance extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_close_in_the_distance")
	public static final Item block = null;
	public ItemAMDCloseInTheDistance(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 80);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_close_in_the_distance", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_close_in_the_distance",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.closeinthedistance")));
