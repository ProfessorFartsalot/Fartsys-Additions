...
public class ShardWaterItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_water")
	public static final Item block = null;

	public ShardWaterItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 25);
	}
