...
public class AMDInsatiableChipsItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_insatiable_chips")
	public static final Item block = null;

	public AMDInsatiableChipsItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 88);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.insatiablechips")),
