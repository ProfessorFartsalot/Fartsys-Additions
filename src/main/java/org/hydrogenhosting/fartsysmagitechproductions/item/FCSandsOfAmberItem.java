...
public class FCSandsOfAmberItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_sands_of_amber")
	public static final Item block = null;

	public FCSandsOfAmberItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 151);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fc_sands_of_amber");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for Sands of Amber."));
		}
	}
}
