...
public class AMDBurningBattlefieldItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_burning_battlefield")
	public static final Item block = null;

	public AMDBurningBattlefieldItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 78);
	}
