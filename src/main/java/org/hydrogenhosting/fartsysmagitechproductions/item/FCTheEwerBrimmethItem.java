...
public class FCTheEwerBrimmethItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_the_ewer_brimmeth")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for The Ewer Brimmeth."));
		}
	}
}
