...
public class ItemAMDChipOilJiggleTune extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_chip_oil_jiggle_tune")
	public static final Item block = null;
	public ItemAMDChipOilJiggleTune(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 80);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_chip_oil_jiggle_tune", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_chip_oil_jiggle_tune",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.chipoiljiggletune")));
