...
public class ShardUnaspectedItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_unaspected")
	public static final Item block = null;

	public ShardUnaspectedItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 22);
	}
