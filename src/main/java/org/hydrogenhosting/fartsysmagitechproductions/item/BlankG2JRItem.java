...
public class BlankG2JRItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:blank_g_2_jr")
	public static final Item block = null;

	public BlankG2JRItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 32);
	}
