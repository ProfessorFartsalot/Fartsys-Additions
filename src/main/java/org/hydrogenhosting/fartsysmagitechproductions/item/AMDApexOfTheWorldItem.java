...
public class AMDApexOfTheWorldItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_apex_of_the_world")
	public static final Item block = null;

	public AMDApexOfTheWorldItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 71);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.chipsofthetunes")),
