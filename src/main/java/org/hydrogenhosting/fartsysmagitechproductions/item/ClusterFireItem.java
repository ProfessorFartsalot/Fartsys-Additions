...
public class ClusterFireItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_fire")
	public static final Item block = null;

	public ClusterFireItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 15);
	}
