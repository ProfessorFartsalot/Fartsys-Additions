...
public class AMDExponentialEntropyPrimalsItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_exponential_entropy_primals")
	public static final Item block = null;

	public AMDExponentialEntropyPrimalsItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 85);
	}
