...
public class CrystalLightningItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:crystal_lightning")
	public static final Item block = null;

	public CrystalLightningItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 20);
	}
