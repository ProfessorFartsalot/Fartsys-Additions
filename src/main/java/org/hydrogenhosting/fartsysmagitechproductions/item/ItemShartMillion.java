...
public class ItemShartMillion extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:shart_million")
	public static final Item block = null;
	public ItemShartMillion(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 61);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:shart_million", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("shart_million");
			setRegistryName("shart_million");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("A small load of one million sharts.");
		}
	}
}
