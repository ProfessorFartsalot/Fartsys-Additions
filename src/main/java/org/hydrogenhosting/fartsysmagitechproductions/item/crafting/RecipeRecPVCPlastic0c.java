...
public class RecipeRecPVCPlastic0c extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic0c(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 210);
	}
