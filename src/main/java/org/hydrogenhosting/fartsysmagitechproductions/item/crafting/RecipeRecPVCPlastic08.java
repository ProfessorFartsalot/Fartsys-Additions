...
public class RecipeRecPVCPlastic08 extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic08(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 162);
	}
