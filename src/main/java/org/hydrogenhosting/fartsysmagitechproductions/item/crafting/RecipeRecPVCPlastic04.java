...
public class RecipeRecPVCPlastic04 extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic04(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 156);
	}
