...
public class RecipeRecPVCPlastic07 extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic07(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 205);
	}
