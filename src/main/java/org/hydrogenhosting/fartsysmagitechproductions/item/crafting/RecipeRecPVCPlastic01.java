...
public class RecipeRecPVCPlastic01 extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic01(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 199);
	}
