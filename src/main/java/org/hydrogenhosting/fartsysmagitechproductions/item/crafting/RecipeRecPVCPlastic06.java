...
public class RecipeRecPVCPlastic06 extends ElementsFartsysmagitechproductionsMod.ModElement {
	public RecipeRecPVCPlastic06(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 158);
	}
