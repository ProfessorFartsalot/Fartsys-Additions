...
public class ShartHundredItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_hundred")
	public static final Item block = null;

	public ShartHundredItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A hundred sharts."));
		}
	}
}
