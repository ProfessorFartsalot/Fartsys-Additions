...
public class ShardFireItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_fire")
	public static final Item block = null;

	public ShardFireItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 13);
	}
