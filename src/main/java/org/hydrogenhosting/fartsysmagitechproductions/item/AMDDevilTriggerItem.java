...
public class AMDDevilTriggerItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_devil_trigger")
	public static final Item block = null;

	public AMDDevilTriggerItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 81);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.chiptunetrigger")),
