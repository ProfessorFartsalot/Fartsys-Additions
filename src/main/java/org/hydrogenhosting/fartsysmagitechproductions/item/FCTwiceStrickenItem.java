...
public class FCTwiceStrickenItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_twice_stricken")
	public static final Item block = null;

	public FCTwiceStrickenItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 147);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fc_twice_stricken");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for Twice Stricken."));
		}
	}
}
