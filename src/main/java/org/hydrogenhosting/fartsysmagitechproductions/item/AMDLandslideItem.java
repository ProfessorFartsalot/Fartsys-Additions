...
public class AMDLandslideItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_landslide")
	public static final Item block = null;

	public AMDLandslideItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 90);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.landslide")),
