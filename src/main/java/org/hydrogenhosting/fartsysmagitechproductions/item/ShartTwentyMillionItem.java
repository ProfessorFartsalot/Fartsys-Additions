...
import org.hydrogenhosting.fartsysmagitechproductions.procedures.ShartTenMillionItemIsDroppedByPlayerProcedure;
...
public class ShartTwentyMillionItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_twenty_million")
	public static final Item block = null;

	public ShartTwentyMillionItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 64);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Twenty MILLION sharts. What are you EATING???? That's like"));
			list.add(new StringTextComponent("a weapon of ass destruction! Oh wait-"));
		}
