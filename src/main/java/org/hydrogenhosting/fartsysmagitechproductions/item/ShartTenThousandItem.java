...
public class ShartTenThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_ten_thousand")
	public static final Item block = null;

	public ShartTenThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 57);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ten thousand sharts"));
		}
	}
}
