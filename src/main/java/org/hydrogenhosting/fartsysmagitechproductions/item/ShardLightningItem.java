...
public class ShardLightningItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_lightning")
	public static final Item block = null;

	public ShardLightningItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 19);
	}
