...
public class ItemShartTenMillion extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:shart_ten_million")
	public static final Item block = null;
	public ItemShartTenMillion(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 63);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:shart_ten_million", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("shart_ten_million");
