...
public class ItemFCLocus extends ElementsFartsysmagitechproductionsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:fc_locus", "inventory"));
	}
