...
public class ShartTenItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_ten")
	public static final Item block = null;

	public ShartTenItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Ten sharts."));
		}
	}
}
