...
import org.hydrogenhosting.fartsysmagitechproductions.procedure.ProcedureJRAthenaTheTirelessOneRightClickedInAir;
...
public class ItemJRAthenaTheTirelessOne extends ElementsFartsysmagitechproductionsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:jr_athena_the_tireless_one", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Right click in hand to obtain a copy of Athena the Tireless One");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureJRAthenaTheTirelessOneRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
