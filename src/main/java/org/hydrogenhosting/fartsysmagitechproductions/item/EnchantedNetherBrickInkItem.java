...
public class EnchantedNetherBrickInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_nether_brick_ink")
	public static final Item block = null;

	public EnchantedNetherBrickInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 42);
	}
