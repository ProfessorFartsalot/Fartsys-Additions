...
public class FCFiendItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:fc_fiend")
	public static final Item block = null;

	public FCFiendItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 152);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Timeworn pages of sheet music containing the full score for Fiend."));
		}
	}
}
