...
public class ShartHundredThousandItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_hundred_thousand")
	public static final Item block = null;

	public ShartHundredThousandItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 59);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("One hundred thousand sharts."));
		}
	}
}
