...
public class AMDDynamiteItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_dynamite")
	public static final Item block = null;

	public AMDDynamiteItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 83);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.dynamitechiptune")),
