...
public class AMDBetweenHeavenAndEarthItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_between_heaven_and_earth")
	public static final Item block = null;

	public AMDBetweenHeavenAndEarthItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 75);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.betweenchipsandtunes")),
