...
public class ClusterLightningItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_lightning")
	public static final Item block = null;

	public ClusterLightningItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 21);
	}
