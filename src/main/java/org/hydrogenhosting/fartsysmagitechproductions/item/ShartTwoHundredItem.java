...
public class ShartTwoHundredItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shart_two_hundred")
	public static final Item block = null;

	public ShartTwoHundredItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 54);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Two hundred sharts."));
		}
	}
}
