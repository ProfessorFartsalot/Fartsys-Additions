...
import org.hydrogenhosting.fartsysmagitechproductions.procedure.ProcedureJRFootfallsRightClickedInAir;
...
public class ItemJRFootfalls extends ElementsFartsysmagitechproductionsMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:jr_footfalls", "inventory"));
	}
