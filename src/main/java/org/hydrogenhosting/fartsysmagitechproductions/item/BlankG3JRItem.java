...
public class BlankG3JRItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:blank_g_3_jr")
	public static final Item block = null;

	public BlankG3JRItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 33);
	}
