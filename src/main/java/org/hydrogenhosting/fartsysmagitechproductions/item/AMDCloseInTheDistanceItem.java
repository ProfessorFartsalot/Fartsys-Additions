...
public class AMDCloseInTheDistanceItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_close_in_the_distance")
	public static final Item block = null;

	public AMDCloseInTheDistanceItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 80);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.closeinthedistance")),
