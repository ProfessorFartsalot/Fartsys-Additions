...
public class AMDBatCountryItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_bat_country")
	public static final Item block = null;

	public AMDBatCountryItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 73);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.chipcountry")),
