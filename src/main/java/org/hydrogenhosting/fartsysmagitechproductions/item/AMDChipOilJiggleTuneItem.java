...
public class AMDChipOilJiggleTuneItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_chip_oil_jiggle_tune")
	public static final Item block = null;

	public AMDChipOilJiggleTuneItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 79);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.chipoiljiggletune")),
