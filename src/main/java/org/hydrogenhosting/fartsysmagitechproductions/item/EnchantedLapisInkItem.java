...
public class EnchantedLapisInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_lapis_ink")
	public static final Item block = null;

	public EnchantedLapisInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 37);
	}
