...
public class AMDBattleItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_battle")
	public static final Item block = null;

	public AMDBattleItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 74);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:xc2.battle")),
