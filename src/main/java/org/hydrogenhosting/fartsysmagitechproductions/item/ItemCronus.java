...
public class ItemCronus extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:cronus")
	public static final Item block = null;
	public ItemCronus(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 44);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("cronus").setRegistryName("cronus").setCreativeTab(TabFartsysAdditions.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechproductions:cronus", "inventory"));
	}
