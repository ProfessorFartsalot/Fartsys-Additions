...
public class CrystalEarthItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:crystal_earth")
	public static final Item block = null;

	public CrystalEarthItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 11);
	}
