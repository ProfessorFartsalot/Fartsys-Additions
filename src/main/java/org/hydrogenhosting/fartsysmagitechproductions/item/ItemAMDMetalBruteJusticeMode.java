...
public class ItemAMDMetalBruteJusticeMode extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_metal_brute_justice_mode")
	public static final Item block = null;
	public ItemAMDMetalBruteJusticeMode(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 94);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_metal_brute_justice_mode", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_metal_brute_justice_mode",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.metalbrutejusticemode")));
