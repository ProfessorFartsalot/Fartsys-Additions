...
public class ShardIceItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:shard_ice")
	public static final Item block = null;

	public ShardIceItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 16);
	}
