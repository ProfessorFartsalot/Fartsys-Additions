...
public class AMDFiendItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_fiend")
	public static final Item block = null;

	public AMDFiendItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 86);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.fiend")),
