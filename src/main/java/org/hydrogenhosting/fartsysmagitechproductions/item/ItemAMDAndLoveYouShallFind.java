...
public class ItemAMDAndLoveYouShallFind extends ElementsFartsysmagitechproductionsMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechproductions:amd_and_love_you_shall_find")
	public static final Item block = null;
	public ItemAMDAndLoveYouShallFind(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 70);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechproductions:amd_and_love_you_shall_find", "inventory"));
	}
	public static class MusicDiscItemCustom extends ItemRecord {
		public MusicDiscItemCustom() {
			super("amd_and_love_you_shall_find",
					ElementsFartsysmagitechproductionsMod.sounds.get(new ResourceLocation("fartsysmagitechproductions:ffxiv.andloveyoushallfind")));
