...
public class EnchantedGlowstoneInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_glowstone_ink")
	public static final Item block = null;

	public EnchantedGlowstoneInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 39);
	}
