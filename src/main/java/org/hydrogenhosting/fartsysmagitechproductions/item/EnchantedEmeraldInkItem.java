...
public class EnchantedEmeraldInkItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:enchanted_emerald_ink")
	public static final Item block = null;

	public EnchantedEmeraldInkItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 40);
	}
