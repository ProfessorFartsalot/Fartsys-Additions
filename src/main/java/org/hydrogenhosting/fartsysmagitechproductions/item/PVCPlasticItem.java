...
public class PVCPlasticItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:pvc_dust")
	public static final Item block = null;

	public PVCPlasticItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 45);
	}
