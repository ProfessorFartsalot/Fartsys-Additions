...
public class ClusterWindItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:cluster_wind")
	public static final Item block = null;

	public ClusterWindItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 30);
	}
