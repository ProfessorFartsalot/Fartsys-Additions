...
public class AMDExponentialChiptuneItem extends FartsysmagitechproductionsModElements.ModElement {
	@ObjectHolder("fartsysmagitechproductions:amd_exponential_chiptune")
	public static final Item block = null;

	public AMDExponentialChiptuneItem(FartsysmagitechproductionsModElements instance) {
		super(instance, 84);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysmagitechproductionsModElements.sounds.get(new ResourceLocation("fartsysmagitechproductions:fartsy.exponentialchiptune")),
