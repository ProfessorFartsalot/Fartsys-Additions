...
public class ProcedureShartSpecialFoodEaten extends ElementsFartsysmagitechproductionsMod.ModElement {
	public ProcedureShartSpecialFoodEaten(ElementsFartsysmagitechproductionsMod instance) {
		super(instance, 148);
	}
