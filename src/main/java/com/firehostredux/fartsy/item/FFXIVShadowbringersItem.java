...
public class FFXIVShadowbringersItem extends RecordItem {
	public FFXIVShadowbringersItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.shadowbringers")),
