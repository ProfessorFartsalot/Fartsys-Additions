...
public class MagitekMusicPressItem extends Item {
	public MagitekMusicPressItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Creates music disc blanks"));
		list.add(new TextComponent("as well as music discs from blanks."));
	}
}
