...
public class XBCYouWillKnowOurNamesItem extends RecordItem {
	public XBCYouWillKnowOurNamesItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:xc.youwillknowournames")),
