...
public class SlipknotPsychosocialItem extends RecordItem {
	public SlipknotPsychosocialItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:slipknot.psychosocial")),
