...
public class FFXIVALandLongDeadItem extends RecordItem {
	public FFXIVALandLongDeadItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.alandlongdead")),
