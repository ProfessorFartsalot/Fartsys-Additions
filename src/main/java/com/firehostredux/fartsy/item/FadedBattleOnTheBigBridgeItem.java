...
public class FadedBattleOnTheBigBridgeItem extends Item {
	public FadedBattleOnTheBigBridgeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Battle On The Big Bridge. Can be restored by alchemy."));
	}
}
