...
public class NGEACruelAngelsThesisItem extends RecordItem {
	public NGEACruelAngelsThesisItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:nge.cruelangelsthesis")),
