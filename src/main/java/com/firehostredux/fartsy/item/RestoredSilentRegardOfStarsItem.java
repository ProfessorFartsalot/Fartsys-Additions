...
public class RestoredSilentRegardOfStarsItem extends Item {
	public RestoredSilentRegardOfStarsItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of The Silent Regard of Stars. Can be pressed into a music disc."));
	}
}
