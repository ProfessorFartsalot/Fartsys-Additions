...
public class RestoredCloseInTheDistanceItem extends Item {
	public RestoredCloseInTheDistanceItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Close in the Distance. Can be pressed into a music disc."));
	}
}
