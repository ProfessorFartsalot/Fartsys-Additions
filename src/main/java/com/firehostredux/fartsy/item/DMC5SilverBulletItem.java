...
public class DMC5SilverBulletItem extends RecordItem {
	public DMC5SilverBulletItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:dmc5.silverbullet")),
