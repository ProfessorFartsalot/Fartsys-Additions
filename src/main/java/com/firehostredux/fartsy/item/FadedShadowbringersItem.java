...
public class FadedShadowbringersItem extends Item {
	public FadedShadowbringersItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Shadowbringers. Can be restored by alchemy."));
	}
}
