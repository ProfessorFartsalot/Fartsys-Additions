...
public class RestoredWoeThatIsMadnessItem extends Item {
	public RestoredWoeThatIsMadnessItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Woe That Is Madness. Can be pressed into a music disc."));
	}
}
