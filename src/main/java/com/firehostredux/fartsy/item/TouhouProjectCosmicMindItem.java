...
public class TouhouProjectCosmicMindItem extends RecordItem {
	public TouhouProjectCosmicMindItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:touhou.cosmicmind")),
