...
public class RestoredKnowledgeNeverSleepsItem extends Item {
	public RestoredKnowledgeNeverSleepsItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Knowledge Never Sleeps. Can be pressed into a music disc."));
	}
}
