...
public class RestoredSilentScreamItem extends Item {
	public RestoredSilentScreamItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Silent Scream. Can be pressed into a music disc."));
	}
}
