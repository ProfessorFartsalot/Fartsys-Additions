...
public class TouhouProjectNecrofantasiaItem extends RecordItem {
	public TouhouProjectNecrofantasiaItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:touhou.necrofantasia")),
