...
public class RestoredFootfallsItem extends Item {
	public RestoredFootfallsItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Footfalls. Can be pressed into a music disc."));
	}
}
