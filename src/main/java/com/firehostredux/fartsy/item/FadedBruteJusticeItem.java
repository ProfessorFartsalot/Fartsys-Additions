...
public class FadedBruteJusticeItem extends Item {
	public FadedBruteJusticeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Metal - Brute Justice Mode. Can be restored by alchemy."));
	}
}
