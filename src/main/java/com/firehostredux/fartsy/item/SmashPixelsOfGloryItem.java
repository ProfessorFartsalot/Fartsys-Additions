...
public class SmashPixelsOfGloryItem extends RecordItem {
	public SmashPixelsOfGloryItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:smash.pixelsofglory")),
