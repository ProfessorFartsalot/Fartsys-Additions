...
public class FFXIVLandslideItem extends RecordItem {
	public FFXIVLandslideItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.landslide")),
