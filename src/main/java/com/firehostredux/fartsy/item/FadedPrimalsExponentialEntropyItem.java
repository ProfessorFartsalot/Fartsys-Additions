...
public class FadedPrimalsExponentialEntropyItem extends Item {
	public FadedPrimalsExponentialEntropyItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of The Primals - Exponential Entropy. Can be restored by alchemy."));
	}
}
