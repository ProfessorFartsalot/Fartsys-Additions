...
public class FadedToTheEdgeItem extends Item {
	public FadedToTheEdgeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of To The Edge. Can be restored by alchemy."));
	}
}
