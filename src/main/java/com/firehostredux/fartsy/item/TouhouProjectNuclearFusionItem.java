...
public class TouhouProjectNuclearFusionItem extends RecordItem {
	public TouhouProjectNuclearFusionItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:touhou.nuclearfusion")),
