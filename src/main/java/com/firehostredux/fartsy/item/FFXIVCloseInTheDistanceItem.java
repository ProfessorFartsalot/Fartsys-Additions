...
public class FFXIVCloseInTheDistanceItem extends RecordItem {
	public FFXIVCloseInTheDistanceItem() {
		super(0, FartsysAdditionsModSounds.REGISTRY.get(new ResourceLocation("fartsys_additions:ffxiv.closeinthedistance")),
