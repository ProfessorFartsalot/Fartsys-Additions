...
public class FadedExponentialEntropyItem extends Item {
	public FadedExponentialEntropyItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Exponential Entropy. Can be restored by alchemy."));
	}
}
