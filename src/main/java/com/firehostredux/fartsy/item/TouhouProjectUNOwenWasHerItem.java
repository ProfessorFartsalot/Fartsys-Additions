...
public class TouhouProjectUNOwenWasHerItem extends RecordItem {
	public TouhouProjectUNOwenWasHerItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:touhou.unowenwasher")),
