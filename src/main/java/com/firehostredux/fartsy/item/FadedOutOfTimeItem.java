...
public class FadedOutOfTimeItem extends Item {
	public FadedOutOfTimeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Out Of Time. Can be restored by alchemy."));
	}
}
