...
public class RestoredPrimalsExponentialEntropyItem extends Item {
	public RestoredPrimalsExponentialEntropyItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Exponential Entropy. Can be pressed into a music disc."));
	}
}
