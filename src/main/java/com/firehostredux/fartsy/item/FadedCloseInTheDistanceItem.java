...
public class FadedCloseInTheDistanceItem extends Item {
	public FadedCloseInTheDistanceItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Close in the Distance. Can be restored by alchemy."));
	}
}
