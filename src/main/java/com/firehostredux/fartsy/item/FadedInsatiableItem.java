...
public class FadedInsatiableItem extends Item {
	public FadedInsatiableItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Insatiable. Can be restored by alchemy."));
	}
}
