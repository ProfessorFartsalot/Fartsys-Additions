...
public class FadedPrimalsBruteJusticeItem extends Item {
	public FadedPrimalsBruteJusticeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of The Primals - Metal - Brute Justice Mode. Can be restored by alchemy."));
	}
}
