...
public class VitiatedAetherCrystalItem extends Item {
	public VitiatedAetherCrystalItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("The aether within lies dormant. It could be reawakened by alchemy."));
	}
}
