...
public class RestoredInsatiableItem extends Item {
	public RestoredInsatiableItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Insatiable. Can be pressed into a music disc."));
	}
}
