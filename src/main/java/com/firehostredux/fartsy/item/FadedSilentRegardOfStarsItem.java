...
public class FadedSilentRegardOfStarsItem extends Item {
	public FadedSilentRegardOfStarsItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of The Silent Regard of Stars. Can be restored by alchemy."));
	}
}
