...
public class RestoredShadowbringersItem extends Item {
	public RestoredShadowbringersItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Shadowbringers. Can be pressed into a music disc."));
	}
}
