...
public class FFXIVBattleOnTheBigBridgeItem extends RecordItem {
	public FFXIVBattleOnTheBigBridgeItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.battleonthebigbridge")),
