...
public class FFXIVPrimalsExponentialEntropyItem extends RecordItem {
	public FFXIVPrimalsExponentialEntropyItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.primals.exponentialentropy")),
