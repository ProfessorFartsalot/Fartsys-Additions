...
public class RestoredAgentOfInquiryItem extends Item {
	public RestoredAgentOfInquiryItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Agent of Inquiry. Can be pressed into a music disc."));
	}
}
