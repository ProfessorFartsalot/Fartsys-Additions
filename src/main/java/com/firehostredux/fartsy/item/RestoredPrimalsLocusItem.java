...
public class RestoredPrimalsLocusItem extends Item {
	public RestoredPrimalsLocusItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of The Primals - Locus. Can be pressed into a music disc."));
	}
}
