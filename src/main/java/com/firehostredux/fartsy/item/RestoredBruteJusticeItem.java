...
public class RestoredBruteJusticeItem extends Item {
	public RestoredBruteJusticeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Metal - Brute Justice Mode. Can be pressed into a music disc."));
	}
}
