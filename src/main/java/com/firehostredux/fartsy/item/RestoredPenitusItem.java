...
public class RestoredPenitusItem extends Item {
	public RestoredPenitusItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Penitus. Can be pressed into a music disc."));
	}
}
