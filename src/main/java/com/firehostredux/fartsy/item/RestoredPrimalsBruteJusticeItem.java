...
public class RestoredPrimalsBruteJusticeItem extends Item {
	public RestoredPrimalsBruteJusticeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of The Primals - Metal - Brute Justice Mode"));
	}
}
