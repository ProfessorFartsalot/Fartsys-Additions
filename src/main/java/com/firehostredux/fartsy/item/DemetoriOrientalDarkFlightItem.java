...
public class DemetoriOrientalDarkFlightItem extends RecordItem {
	public DemetoriOrientalDarkFlightItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:demetori.orientaldarkflight")),
