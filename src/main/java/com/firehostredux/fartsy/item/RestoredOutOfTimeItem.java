...
public class RestoredOutOfTimeItem extends Item {
	public RestoredOutOfTimeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Out Of Time. Can be pressed into a music disc."));
	}
}
