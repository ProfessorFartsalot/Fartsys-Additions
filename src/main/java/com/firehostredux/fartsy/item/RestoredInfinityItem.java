...
public class RestoredInfinityItem extends Item {
	public RestoredInfinityItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Infinity. Can be pressed into a music disc."));
	}
}
