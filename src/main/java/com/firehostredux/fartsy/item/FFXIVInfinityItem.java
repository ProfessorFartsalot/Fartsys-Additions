...
public class FFXIVInfinityItem extends RecordItem {
	public FFXIVInfinityItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.infinity")),
