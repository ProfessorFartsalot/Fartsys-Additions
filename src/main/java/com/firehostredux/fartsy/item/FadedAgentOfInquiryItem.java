...
public class FadedAgentOfInquiryItem extends Item {
	public FadedAgentOfInquiryItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Agent of Inquiry. Can be restored by alchemy."));
	}
}
