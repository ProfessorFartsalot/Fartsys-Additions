...
public class RestoredToTheEdgeItem extends Item {
	public RestoredToTheEdgeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of To The Edge. Can be pressed into a music disc."));
	}
}
