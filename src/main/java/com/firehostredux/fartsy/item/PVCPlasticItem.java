...
public class PVCPlasticItem extends Item {
	public PVCPlasticItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Brewed and or melted plastic. Can be used with a press to make blank music discs."));
	}
}
