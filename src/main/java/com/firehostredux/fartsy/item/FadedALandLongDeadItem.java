...
public class FadedALandLongDeadItem extends Item {
	public FadedALandLongDeadItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of A Land Long Dead. Can be restored by alchemy."));
	}
}
