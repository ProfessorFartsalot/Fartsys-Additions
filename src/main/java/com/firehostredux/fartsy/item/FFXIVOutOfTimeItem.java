...
public class FFXIVOutOfTimeItem extends RecordItem {
	public FFXIVOutOfTimeItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.outoftime")),
