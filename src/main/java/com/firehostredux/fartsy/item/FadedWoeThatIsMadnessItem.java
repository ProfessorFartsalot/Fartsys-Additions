...
public class FadedWoeThatIsMadnessItem extends Item {
	public FadedWoeThatIsMadnessItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Woe That Is Madness. Can be restored by alchemy."));
	}
}
