...
public class RestoredBattleOnTheBigBridgeItem extends Item {
	public RestoredBattleOnTheBigBridgeItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Battle On The Big Bridge. Can be pressed into a music disc."));
	}
}
