...
public class FadedLunarWhaleItem extends Item {
	public FadedLunarWhaleItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A faded copy of Lunar Whale. Can be restored by alchemy."));
	}
}
