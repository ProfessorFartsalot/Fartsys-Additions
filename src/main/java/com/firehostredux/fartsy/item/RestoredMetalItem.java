...
public class RestoredMetalItem extends Item {
	public RestoredMetalItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Metal. Can be pressed into a music disc."));
	}
}
