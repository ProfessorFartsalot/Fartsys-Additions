...
public class FFXIVUnderTheWeightItem extends RecordItem {
	public FFXIVUnderTheWeightItem() {
		super(0, FartsysMagitekFantasyModSounds.REGISTRY.get(new ResourceLocation("fartsys_magitek_fantasy:ffxiv.undertheweight")),
