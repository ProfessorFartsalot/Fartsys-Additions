...
public class RestoredLandslideItem extends Item {
	public RestoredLandslideItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of Landslide. Can be pressed into a music disc."));
	}
}
