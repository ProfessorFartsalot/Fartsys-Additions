...
public class RestoredALandLongDeadItem extends Item {
	public RestoredALandLongDeadItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("A restored copy of A Land Long Dead. Can be pressed into a music disc."));
	}
}
