...
public class JRPaPayaRightClickedInAirProcedure {
	public static void execute(Entity entity) {
		...
		if (entity instanceof Player _player) {
			ItemStack _setstack = new ItemStack(FartsysmagitechfantasyModItems.AMD_PA_PAYA.get()).copy();
			_setstack.setCount(1);
			ItemHandlerHelper.giveItemToPlayer(_player, _setstack);
		}
		if (entity instanceof Player _player) {
			ItemStack _stktoremove = new ItemStack(FartsysmagitechfantasyModItems.JR_PA_PAYA.get());
