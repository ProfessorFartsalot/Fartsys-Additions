...
public class FFXIVOutOfTimeItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_out_of_time")
	public static final Item block = null;

	public FFXIVOutOfTimeItem(FartsysAdditionsModElements instance) {
		super(instance, 27);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.outoftime")),
