...
public class DemetoriWorldsEndItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:demetori_worlds_end")
	public static final Item block = null;

	public DemetoriWorldsEndItem(FartsysAdditionsModElements instance) {
		super(instance, 39);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:demetori.worldsend")),
