...
public class ItemResonantAether extends ElementsFartsysmagitechfantasyMod.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 1;
			setUnlocalizedName("resonant_aether");
			setRegistryName("resonant_aether");
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("A vial of resonant aether. Can be dehydrated to make restored aether crystals.");
		}
	}
}
