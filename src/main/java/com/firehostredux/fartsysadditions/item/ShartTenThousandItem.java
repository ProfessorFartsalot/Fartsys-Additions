...
public class ShartTenThousandItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:shart_ten_thousand")
	public static final Item block = null;

	public ShartTenThousandItem(FartsysAdditionsModElements instance) {
		super(instance, 6);
	}
