...
public class XBC2BattleItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:xbc_2_battle")
	public static final Item block = null;

	public XBC2BattleItem(FartsysAdditionsModElements instance) {
		super(instance, 47);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:xc2.battle")),
