...
public class DMC5DevilTriggerItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:dmc_5_devil_trigger")
	public static final Item block = null;

	public DMC5DevilTriggerItem(FartsysAdditionsModElements instance) {
		super(instance, 41);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:dmc5.deviltrigger")),
