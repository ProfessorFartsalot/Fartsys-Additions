...
public class FFXIVShadowbringersItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_shadowbringers")
	public static final Item block = null;

	public FFXIVShadowbringersItem(FartsysAdditionsModElements instance) {
		super(instance, 28);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.shadowbringers")),
