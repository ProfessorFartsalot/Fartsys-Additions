...
public class ShartTenItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:shart_ten")
	public static final Item block = null;

	public ShartTenItem(FartsysAdditionsModElements instance) {
		super(instance, 3);
	}
