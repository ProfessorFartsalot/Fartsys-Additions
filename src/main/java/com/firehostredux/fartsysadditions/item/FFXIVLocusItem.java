...
public class FFXIVLocusItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_locus")
	public static final Item block = null;

	public FFXIVLocusItem(FartsysAdditionsModElements instance) {
		super(instance, 23);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.locus")),
