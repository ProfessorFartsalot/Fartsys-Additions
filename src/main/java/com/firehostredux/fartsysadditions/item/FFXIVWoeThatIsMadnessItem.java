...
public class FFXIVWoeThatIsMadnessItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_woe_that_is_madness")
	public static final Item block = null;

	public FFXIVWoeThatIsMadnessItem(FartsysAdditionsModElements instance) {
		super(instance, 31);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.woethatismadness")),
