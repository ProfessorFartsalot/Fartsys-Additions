...
public class FFXIVLunarWhaleItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_lunar_whale")
	public static final Item block = null;

	public FFXIVLunarWhaleItem(FartsysAdditionsModElements instance) {
		super(instance, 25);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.lunarwhale")),
