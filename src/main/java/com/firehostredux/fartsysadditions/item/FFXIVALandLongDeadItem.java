...
public class FFXIVALandLongDeadItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiva_land_long_dead")
	public static final Item block = null;

	public FFXIVALandLongDeadItem(FartsysAdditionsModElements instance) {
		super(instance, 13);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.alandlongdead")),
