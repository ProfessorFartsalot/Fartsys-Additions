...
public class ItemJRFromTheHeavens extends ElementsFartsysmagitechfantasyMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechfantasy:jr_from_the_heavens", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Right click in hand to obtain a copy of From The Heavens");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureJRFromTheHeavensRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
