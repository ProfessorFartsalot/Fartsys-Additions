...
public class ItemJRAthenaTheTirelessOne extends ElementsFartsysmagitechfantasyMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechfantasy:jr_athena_the_tireless_one", "inventory"));
	}
