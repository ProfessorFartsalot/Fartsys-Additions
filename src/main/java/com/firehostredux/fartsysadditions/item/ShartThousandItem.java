...
public class ShartThousandItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:shart_thousand")
	public static final Item block = null;

	public ShartThousandItem(FartsysAdditionsModElements instance) {
		super(instance, 5);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Strength of a thousand sharts."));
		}
	}
}
