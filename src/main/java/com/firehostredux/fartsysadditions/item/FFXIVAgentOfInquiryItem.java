...
public class FFXIVAgentOfInquiryItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_agent_of_inquiry")
	public static final Item block = null;

	public FFXIVAgentOfInquiryItem(FartsysAdditionsModElements instance) {
		super(instance, 12);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.agentofinquiry")),
