...
public class ShartHundredThousandItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:shart_hundred_thousand")
	public static final Item block = null;

	public ShartHundredThousandItem(FartsysAdditionsModElements instance) {
		super(instance, 7);
	}
