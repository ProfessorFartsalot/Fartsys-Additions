...
public class ShartHundredItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:shart_hundred")
	public static final Item block = null;

	public ShartHundredItem(FartsysAdditionsModElements instance) {
		super(instance, 4);
	}
