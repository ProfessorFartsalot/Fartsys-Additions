...
public class ItemJRTornFromTheHeavensOrchestral extends ElementsFartsysmagitechfantasyMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0,
				new ModelResourceLocation("fartsysmagitechfantasy:jr_torn_from_the_heavens_orchestral", "inventory"));
	}
