...
public class FFXIVLandslideItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_landslide")
	public static final Item block = null;

	public FFXIVLandslideItem(FartsysAdditionsModElements instance) {
		super(instance, 22);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.landslide")),
