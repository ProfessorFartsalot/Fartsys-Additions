...
public class RecipeRecPVCPlastic0b extends ElementsFartsysmagitechfantasyMod.ModElement {
	public RecipeRecPVCPlastic0b(ElementsFartsysmagitechfantasyMod instance) {
		super(instance, 150);
	}
