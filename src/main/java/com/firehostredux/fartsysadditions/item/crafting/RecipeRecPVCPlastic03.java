...
public class RecipeRecPVCPlastic03 extends ElementsFartsysmagitechfantasyMod.ModElement {
	public RecipeRecPVCPlastic03(ElementsFartsysmagitechfantasyMod instance) {
		super(instance, 62);
	}
