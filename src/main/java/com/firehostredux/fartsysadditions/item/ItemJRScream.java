...
public class ItemJRScream extends ElementsFartsysmagitechfantasyMod.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("fartsysmagitechfantasy:jr_scream", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<String> list, ITooltipFlag flag) {
			...
			list.add("Right click in hand to obtain a copy of Scream");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer entity, EnumHand hand) {
			...
			int z = (int) entity.posZ;
			{
				...
				ProcedureJRScreamRightClickedInAir.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
