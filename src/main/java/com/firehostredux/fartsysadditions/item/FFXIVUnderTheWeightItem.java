...
public class FFXIVUnderTheWeightItem extends FartsysAdditionsModElements.ModElement {
	@ObjectHolder("fartsys_additions:ffxiv_under_the_weight")
	public static final Item block = null;

	public FFXIVUnderTheWeightItem(FartsysAdditionsModElements instance) {
		super(instance, 30);
	}
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, FartsysAdditionsModElements.sounds.get(new ResourceLocation("fartsys_additions:ffxiv.undertheweight")),
