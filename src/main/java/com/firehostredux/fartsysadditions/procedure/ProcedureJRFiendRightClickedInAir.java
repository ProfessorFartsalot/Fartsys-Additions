...
import com.firehostredux.fartsysadditions.item.ItemJRFiend;
import com.firehostredux.fartsysadditions.item.ItemAMDFiend;
import com.firehostredux.fartsysadditions.ElementsFartsysmagitechfantasyMod;

@ElementsFartsysmagitechfantasyMod.ModElement.Tag
public class ProcedureJRFiendRightClickedInAir extends ElementsFartsysmagitechfantasyMod.ModElement {
	public ProcedureJRFiendRightClickedInAir(ElementsFartsysmagitechfantasyMod instance) {
		super(instance, 412);
	}
