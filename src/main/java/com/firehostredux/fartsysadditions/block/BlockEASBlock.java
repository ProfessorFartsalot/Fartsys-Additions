...
public class BlockEASBlock extends ElementsFartsysmagitechfantasyMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechfantasy:eas_block")
	public static final Block block = null;
	public BlockEASBlock(ElementsFartsysmagitechfantasyMod instance) {
		super(instance, 288);
	}
	...
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "fartsysmagitechfantasy:tileentityeas_block");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechfantasy:eas_block", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
				{
					...
					ProcedureEASBlockRedstone.executeProcedure($_dependencies);
				}
			} else {
			}
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			if (entity instanceof EntityPlayer) {
				((EntityPlayer) entity).openGui(FartsysmagitechfantasyMod.instance, GuiEASUI.GUIID, world, x, y, z);
			}
			return true;
		}
	}
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getGuiID() {
			return "fartsysmagitechfantasy:eas_block";
		}
