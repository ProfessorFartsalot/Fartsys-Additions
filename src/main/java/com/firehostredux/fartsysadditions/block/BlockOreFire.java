...
public class BlockOreFire extends ElementsFartsysmagitechfantasyMod.ModElement {
	@GameRegistry.ObjectHolder("fartsysmagitechfantasy:ore_fire")
	public static final Block block = null;
	public BlockOreFire(ElementsFartsysmagitechfantasyMod instance) {
		super(instance, 210);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("fartsysmagitechfantasy:ore_fire", "inventory"));
	}
