 ...
 *
 *    Keep the ElementsFartsysmagitechfantasyMod object in this class and all calls to this object
...
public class FartsysmagitechfantasyMod {
	...
	@Mod.Instance(MODID)
	public static FartsysmagitechfantasyMod instance;
	public ElementsFartsysmagitechfantasyMod elements = new ElementsFartsysmagitechfantasyMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsFartsysmagitechfantasyMod.GuiHandler());
